package br.com.saurs.ecommerce.controllers;
...
import br.com.saurs.ecommerce.services.IDepartamentoService;
...
public class DepartamentoController {
  ...
  public ResponseEntity<Departamento> excluir(@PathVariable Integer id) {
  ...
  public ResponseEntity<Departamento> buscarPorId(@PathVariable Integer id) {
    Departamento res = service.buscarPorId(id);
    if (res != null) {
      return ResponseEntity.ok(res);
    }
